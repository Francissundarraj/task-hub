...
function About() {
    ...
    return (
        ...
        <div className="bg-gradient-to-b from-[#ffffff] via-[#1B1F2C] to-[#1D1E1F]">
            <h1 className=" hidden md:block md:text-5xl p-8 my-10 text-center">We are on a mission to improve workplace productivity</h1>
            ...
            <div className=" flex my-16 section 1">
                ...
                <div className=" md:my-16  max-w-[700px] mx-auto" >
                    ...
                    <p className="text-center text-[#141313]">People are more productive and happier if they can work the way they want. Whether it’s about where they work (at home or in the office),
                        how they communicate with co-workers, or what tools they use to get their work done.</p>
                    <p className="text-center text-[#141313]">That’s why Hive is the only project management platform designed by its users.</p>



                    <p className="my-2 text-center text-[#141313]">Because you know what works.</p>
                </div>
            ...
            <div className="flex section 2">
                ...
                <div className="my-16 max-w-[700px] mx-auto">
                    <h1 className="text-xl font-semibold mb-5 text-center">Master Your Time with  <span className="text-2xl text-[#2997a8]"> GoalGetter</span> </h1>
                    <p className="text-center text-[#a8a4a4]">Effective time management is crucial to achieving your goals and staying productive.
            ...
            <div className="flex section 3">
                ...
                <div className="my-16 max-w-[700px] mx-auto">
                    ...
                    <p className="text-center text-[#a8a4a4]">A Task management app is a digital tool that helps you stay organized and on top of your
