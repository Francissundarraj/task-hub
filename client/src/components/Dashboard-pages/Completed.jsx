...
const Completed = () => {
    const { tasks , formatCreatedDate , completedTasks, handleDelete} = useContext(TaskContext);

    return (
        <div>
            <div className='min-h-screen   rounded-3xl mx-5 p-5 bg-[#ffffff0f] backdrop-blur-md border border-[#ffffff1a] shadow-lg '>
            <h1 className='text-2xl font-bold mx-6 mb-5 text-[#c47a7a]'>Completed Tasks</h1>
            <div className='flex  flex-wrap'>
                    {tasks && tasks.length > 0 ? (
                        ...
                        <p className='text-[#EBEBEB]'>No tasks available.</p>
                    )
                    }
                </div>
