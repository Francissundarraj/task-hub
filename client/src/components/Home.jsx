...
function Home() {
  ...
  return (
    <div >
      ...
      <h1 className="text-3xl  text-[#C56F41] font-bold mt-36 m-5  text-center ">  Workflows for any project, big or small </h1>
      ...
      <h1 className="text-3xl text-center text-[#C56F41] font-bold mt-28 m-5 flex items-center justify-center gap-2">
      ...
      <div className="flex flex-wrap justify-center gap-8 mt-10 mb-36">
        ...
        {/* teams collaborate in GoalGetter*/}
        <div className="bg-gradient-to-br from-[#427a8f] to-[#0088CC] text-[#ffff] p-6 rounded-2xl shadow-lg w-64 text-center 
          ...
          <h3 className="text-2xl font-bold">Teams collaborate in GoalGetter</h3>
          <p className="text-4xl font-extrabold mt-2">150+</p>
        </div>

        {/* countries embrace GoalGetter */}
        <div className="bg-gradient-to-br from-[#60b17d] to-[#22C55E] text-white p-6 rounded-2xl shadow-lg w-64 text-center 
          ...
          <h3 className="text-2xl font-bold">Countries embrace GoalGetter</h3>
          <p className="text-4xl font-extrabold mt-2">65</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#867c52] to-[#EAB308] text-white p-6 rounded-2xl shadow-lg w-64 text-center 
          ...
          <h3 className="text-2xl font-bold">Tasks completed in 2024</h3>
          <p className="text-4xl font-extrabold mt-2">1.2M</p>
        </div>
